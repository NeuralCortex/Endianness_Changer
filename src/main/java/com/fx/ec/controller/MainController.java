 ...
 */
package com.fx.ec.controller;

import com.fx.ec.controller.tabs.ChangeController;
import com.fx.ec.Globals;
import com.fx.ec.tools.HelperFunctions;
import java.io.File;
...
public class MainController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle bundle) {
        ...
        Tab tabChange = HelperFunctions.addTab(bundle, tabPane, Globals.FXML_TAB_CHANGE_PATH, new ChangeController(this), bundle.getString("tab.change"));
        /*
        ...
        ((PopulateInterface) tabChange.getContent().getUserData()).populate();
    }
